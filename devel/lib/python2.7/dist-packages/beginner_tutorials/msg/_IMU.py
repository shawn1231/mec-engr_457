...
"""autogenerated by genpy from beginner_tutorials/IMU.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['beginner_tutorials/Accelerometer','beginner_tutorials/Gyroscope','beginner_tutorials/Magnetometer']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.accelerometer is None:
        self.accelerometer = beginner_tutorials.msg.Accelerometer()
      if self.gyroscope is None:
        self.gyroscope = beginner_tutorials.msg.Gyroscope()
      if self.magnetometer is None:
        self.magnetometer = beginner_tutorials.msg.Magnetometer()
    else:
      self.accelerometer = beginner_tutorials.msg.Accelerometer()
      self.gyroscope = beginner_tutorials.msg.Gyroscope()
      self.magnetometer = beginner_tutorials.msg.Magnetometer()
