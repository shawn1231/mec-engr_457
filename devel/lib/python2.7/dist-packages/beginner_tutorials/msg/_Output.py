...
"""autogenerated by genpy from beginner_tutorials/Output.msg. Do not edit."""
import sys
...
class Output(genpy.Message):
  ...
  _type = "beginner_tutorials/Output"
...
"""
  __slots__ = ['pwm','led']
  _slot_types = ['beginner_tutorials/PWM','beginner_tutorials/LED']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.pwm is None:
        self.pwm = beginner_tutorials.msg.PWM()
      if self.led is None:
        self.led = beginner_tutorials.msg.LED()
    else:
      self.pwm = beginner_tutorials.msg.PWM()
      self.led = beginner_tutorials.msg.LED()
