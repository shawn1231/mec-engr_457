...
(cl:defmethod cl:initialize-instance :after ((m <ADC>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ADC)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<ADC> is deprecated: use beginner_tutorials-msg:ADC instead.")))
