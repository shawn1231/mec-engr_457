...
(cl:defmethod cl:initialize-instance :after ((m <Accelerometer>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Accelerometer)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<Accelerometer> is deprecated: use beginner_tutorials-msg:Accelerometer instead.")))
