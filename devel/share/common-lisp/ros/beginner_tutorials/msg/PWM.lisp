...
(cl:defmethod cl:initialize-instance :after ((m <PWM>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PWM)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<PWM> is deprecated: use beginner_tutorials-msg:PWM instead.")))
