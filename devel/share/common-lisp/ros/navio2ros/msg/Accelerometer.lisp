...
(cl:defmethod cl:initialize-instance :after ((m <Accelerometer>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Accelerometer)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navio2ros-msg:<Accelerometer> is deprecated: use navio2ros-msg:Accelerometer instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Accelerometer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navio2ros-msg:x-val is deprecated.  Use navio2ros-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Accelerometer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navio2ros-msg:y-val is deprecated.  Use navio2ros-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Accelerometer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navio2ros-msg:z-val is deprecated.  Use navio2ros-msg:z instead.")
  (z m))
